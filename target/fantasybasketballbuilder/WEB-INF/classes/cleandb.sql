...
DELETE FROM proj_basketball.center;
DELETE FROM proj_basketball.point_guard;
DELETE FROM proj_basketball.power_forward;
DELETE FROM proj_basketball.small_forward;
DELETE FROM proj_basketball.shooting_guard;
DELETE FROM proj_basketball.user_team;
DELETE FROM proj_basketball.user_roles;
DELETE FROM proj_basketball.users;
