    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            <form action= "createTeam" method="POST">
                ...
                <div class="form-group">
                    <div class="ui-widget">
                        <label for="combobox">Point Guard: </label>
                        <select class="form-control" id="combobox" name="pointGuard" required>
                            <c:forEach var="pgPlayer1" items="${pg_data}">
                                <option value="${pgPlayer1.pointGuardID}">${pgPlayer1.firstName}</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
